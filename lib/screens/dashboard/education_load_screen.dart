...
import '../../provider/education_loan_provider.dart';

class SmartEducationLoan extends StatelessWidget {
  SmartEducationLoan({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<EducationLoanProvider>(
