...
import 'college_list_form.dart';
import 'college_list_predict.dart';
import 'college_list_screen.dart';

class CollegePredict extends StatefulWidget {
  @override
  _PremiumPageState createState() => _PremiumPageState();
}

class _PremiumPageState extends State<CollegePredict> {
  String? jeeRank;
  ...
  void initState() {
    ...
    super.initState();
    counselingOptions.addAll(eng_jee);
    counselingOptions.addAll(eng_state);
    counselingOptions.addAll(eng_others);
    counselingOptions.addAll(medical);
    counselingOptions.addAll(law);
    counselingOptions.addAll(management);
  }
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const Text(
                  "College Dost provides free College Predictor Tool for Students to predict the Colleges or Branches they can get based on respective ranks.",
                  style: TextStyle(
                      fontSize: 16,
                      color: Colors.white,
                      fontWeight: FontWeight.bold),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Enter JEE Mains CRL Rank",
                      filled: true,
                      fillColor: Colors.black,
